...
def manageUserDatabase():
    execfile("GUImanageUserDatabase.py")
...
access=Button(root,text="Manage User Database",bg="#00B6F5",fg="#FFF8FA",height=2,width=20,command=manageUserDatabase,borderwidth=0)
