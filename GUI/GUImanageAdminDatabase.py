...
def addAdmin():
    ...
    while found==0:
        ...
        if cursor.fetchall():
            ...
            alreadyExistsMessage=Label(alreadyExists,text="Username Taken, please try again",bg="red",fg="yellow")
    ...
    if password!=passwordR:
        ...
        noMatchMessage=Label(noMatch,text="Please enter the same password!",bg="red",fg="yellow")
