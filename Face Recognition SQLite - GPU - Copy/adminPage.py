...
def accessDatabase():
    execfile("GUIaccessDatabase.py")

def retrainDatabase():
    os.system('2_trainer.py')

def addAdmin():
    execfile("GUIaddAdmin.py")
...
#access database
access=Button(root,text="Manage Database",bg="#00B6F5",fg="#FFF8FA",height=2,width=20,command=accessDatabase,borderwidth=0)
access.config(font=("Helvetica 20 bold"))
access.place(x=500,y=180)

#add admin
addAdmin=Button(root,text="Manage Admins",bg="#00B6F5",fg="#FFF8FA",height=2,width=20,command=addAdmin,borderwidth=0)
