...
def CheckLogin():
    ...
    if results:
        ...
        invalidCloseButton=Button(invalid,text="Close",bg="#F6006B",fg="#FFF8FA",command=invalid.destroy,height = 1, width = 10,borderwidth=0)
        invalidCloseButton.config(font=("Helvetica 15 bold"))
        invalidCloseButton.place(x=600,y=60)
        invalid.mainloop()
